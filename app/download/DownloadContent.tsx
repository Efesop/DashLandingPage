        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-[#f5f5f7] border border-gray-300 rounded-[20px] p-8 relative"
            >
              ...
              <div className="w-16 h-16 bg-white border border-gray-200 rounded-2xl flex items-center justify-center mb-6">
            ...
            >
              ...
              <Link
                ...
                className="w-full py-3 px-6 bg-gray-200 hover:bg-gray-300 text-gray-900 font-semibold rounded-xl transition-colors text-center flex items-center justify-center gap-2"
              >
                Open Web App
