...
export default function ComparisonTable() {
  const comparisonData = [
    ...
    { feature: 'AES-256 Encryption', dash: true, notion: false, evernote: false, obsidian: false },
    { feature: 'No Subscription Required', dash: true, notion: false, evernote: false, obsidian: false },
    ...
    { feature: 'Decoy Password', dash: true, notion: false, evernote: false, obsidian: false },
