...
- Comparisons: `/vs-google-keep`. **`/vs-notion`, `/vs-evernote` and `/vs-obsidian` were deleted on 9 Sep 2026 and 301 to their `*-alternatives` listicles** — they were competing with those pages for the same query and "dash vs X" has no measurable search volume
