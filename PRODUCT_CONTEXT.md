...
- SEO pages: `/private-notes`, `/encrypted-notes`, `/offline-notes`, `/secure-journal`, and (Sep 8 2026, on `ArticleLayout`) `/best-notes-app-for-mac`, `/password-protected-notes`, `/obsidian-alternatives`, `/notion-alternatives`, `/evernote-alternatives`, `/privnote-alternatives`, `/guides/lock-notes-on-iphone-and-mac`, `/open-source-notes-app` — targeting and the build queue live in [SEO.md](./SEO.md). `/for-students` and `/encrypted-notes` moved onto `ArticleLayout` in Sep 2026
